...
def players_eda():
  ...
  plot_line_chart = alt.Chart(st.session_state.df_players.loc[:,['Player','PTS']].sort_values(by='PTS', axis=1)).mark_line(interpolate='basis').encode(alt.X('Player', title='Players'), \
